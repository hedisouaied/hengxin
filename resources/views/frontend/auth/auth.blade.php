                ...
                <div class="login_form mb-50">
                    ...
                    <form action="{{route('login.submit')}}" method="post">
                        ...
                        <div class="form-group">
                            <input type="email" name="email" class="form-control" id="username" placeholder="Email or Username" value="{{old('email')}}">
                            @error('email')
            ...
            <div class="col-12 col-md-6">
                <div class="login_form mb-50">
                    ...
                    <form action="{{route('register.submit')}}" method="post">
                        {{csrf_field()}}
                        <div class="form-group">
                            <input type="text" name="full_name" class="form-control" id="username" placeholder="Full Name" value="{{old('full_name')}}">
                            @error('full_name')
                            <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <input type="email" name="email" class="form-control" id="username" placeholder="Email" value="{{old('email')}}">
                            @error('email')
                            <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
