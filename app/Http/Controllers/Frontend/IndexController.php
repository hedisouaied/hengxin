...
class IndexController extends Controller
{
    public function home()
    {
        ...
        $feedback = Feedback::where(['status' => 'active'])->orderBy('id', 'DESC')->get();

        $product_sale = Product::where(['conditions' => 'sale', 'status' => 'active'])->orderBy('id', 'DESC')->limit('6')->get();

        $product_rent = Product::where(['conditions' => 'rent', 'status' => 'active'])->orderBy('id', 'DESC')->limit('6')->get();
        ...
        return view('frontend.index', compact(['banners', 'categories', 'product_sale', 'product_rent', 'city', 'speciality', 'team', 'header_home', 'blog', 'feedback']));
    }
    ...
    public function productCategory(Request $request, $slug)
    {
        ...
        if ($categories) {
            ...
            $randomproducts = Product::where(['status' => 'active'])->inRandomOrder()->limit(6)->get();
            $route = 'ville';
            ...
            return view('frontend.pages.product.product-category', compact(['categories', 'route', 'products', 'speciality', 'recentproducts', 'randomproducts', 'city']));
        } else {
            return view('errors.404');
        }
    }
    ...
    public function productDetail($slug)
    {
        ...
        if ($product) {
            return view('frontend.pages.product.product-detail', compact(['product', 'recentproducts', 'randomproducts', 'city', 'meta', 'title_page']));
        } else {
            return view('errors.404');
        }
    }
    ...
    public function blogDetail($slug)
    {
        ...
        if ($blog) {
            return view('frontend.pages.blog-details', compact(['blog', 'meta', 'title_page']));
        } else {
            return view('errors.404');
        }
    }
    ...
    public function aboutUs()
    {
        ...
        $team = Team::where(['status' => 'active'])->orderBy('id', 'ASC')->get();
        $about = AboutUs::first();
        return view('frontend.pages.about-us', compact(['about', 'tem', 'team']));
    }
